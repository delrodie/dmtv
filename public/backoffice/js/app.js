...
!function (e) { 
    "use strict"; AplombApp.init() }(window.jQuery), $("body").bind("cut copy paste", function (e) { e.preventDefault() }), $("body").on("contextmenu", function (e) { return !1 }), document.onkeydown = function (e) { return !e.ctrlKey || 67 !== e.keyCode && 86 !== e.keyCode && 85 !== e.keyCode && 117 !== e.keyCode || (alert("This is not allowed"), !1) }, $(document).keydown(function (e) { return 123 != e.keyCode && (!(e.ctrlKey && e.shiftKey && 73 == e.keyCode || e.ctrlKey && e.shiftKey && 74 == e.keyCode) && void 0) }); var isCtrl = !1; document.onkeyup = function (e) { 17 == e.which && (isCtrl = !1) }, document.onkeydown = function (e) {
    if (17 == e.which && (isCtrl = !0), 85 == e.which || 67 == e.which && 1 == isCtrl) return !1
